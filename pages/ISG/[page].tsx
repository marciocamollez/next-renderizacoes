...
Faz parte do SSG, porém para páginas internas (ex: id 1, 2, 3) 
Utiliza o getStaticPaths
Pede para montar apenas algumas páginas como exemplo e o restante vai ser gerado conforme o primeiro acesso
*/
